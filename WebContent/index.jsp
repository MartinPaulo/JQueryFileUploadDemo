...
<body>
	<div class="container">
		...
		<form id="fileupload" action="/JQueryFileUploadDemo/UploadServlet" method="POST" enctype="multipart/form-data">
			...
			<div class="row fileupload-buttonbar">
				<div class="span7">
					...
					<span class="btn btn-success fileinput-button"> <i class="icon-plus icon-white"></i> <span>Add
		...
		<div class="well">
			...
			<ul>
				...
				<li>Based on the <a href="https://github.com/blueimp/jQuery-File-Upload">jQuery-File-Upload widget</a>.
				</li>
	...
	<div id="modal-gallery" class="modal modal-gallery hide fade" data-filter=":odd" tabindex="-1">
		...
		<div class="modal-footer">
			...
			</a> <a class="btn btn-success modal-play modal-slideshow" data-slideshow="5000"> <i class="icon-play icon-white"></i>
				<span>Slideshow</span>
...
{% } %}
	...
	<script src="blueimp/tmpl.js"></script>
	<!-- The Load Image plugin is included for the preview images and image resizing functionality -->
	<script src="blueimp/load-image.js"></script>
	<!-- The Canvas to Blob plugin is included for image resizing functionality -->
	<script src="blueimp/canvas-to-blob.js"></script>
	<!-- Bootstrap JS and Bootstrap Image Gallery are not required, but included for the demo -->
	<script src="bootstrap/js/bootstrap.js"></script>
	<script src="blueimp/bootstrap-image-gallery.js"></script>
